...
def choose_word():
    words = ["словарь", "программа", "санягучимен", "стол", "проигрыватель", "окно", "солнце", "роща", "вопспоминания", "мышь", "монитор", "спокойствие", "ночь", "кран", "удлинитель", "вишня", "мёд", "могучий", "собака", "христианство"]
